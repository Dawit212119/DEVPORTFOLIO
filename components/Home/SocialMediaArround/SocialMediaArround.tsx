  ...
  return (
    ...
    >
      <a href={props.href} className="" target={"_blank"} rel="noreferrer">
        <props.Icon
          className={
            "w-6 h-6 text-gray-400 hover:text-green-500 fill-current hover:cursor-pointer"
          }
        />
      </a>
    </motion.div>
        ...
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a
              ...
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wider text-gray-400 hover:text-[#ff0000]hover:cursor-pointer">
                dawitworkye794<span className="text-green-500">@</span>gmail
