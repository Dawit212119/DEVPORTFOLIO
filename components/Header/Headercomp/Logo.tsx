...
export default function Logo(props: { finishedLoading: boolean }) {
  return (
    ...
    >
      ...
      <motion.span
        initial={{ x: 1 }}
        className="absolute h-full w-full flex justify-center items-center text-lg font-Header text-[#ff0000]"
      >
        D
      </motion.span>
      ...
      <motion.div
        ...
        className="h-1 w-6 rounded bg-[#ff0000]" // Set background color to red
      ></motion.div>
      <motion.div
